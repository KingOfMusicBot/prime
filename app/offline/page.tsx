...
import { HardDriveDownload, WifiOff, RefreshCw } from "lucide-react";
import "../globals.css";
    ...
    <div className="min-h-screen bg-[#0F1908] text-white flex flex-col items-center justify-center p-6 text-center select-none relative overflow-hidden">
      ...
      <div className="z-10 max-w-md w-full p-8 rounded-3xl bg-white/[0.03] border border-white/[0.05] backdrop-blur-xl shadow-2xl flex flex-col items-center animate-scaleIn">
        ...
        <p className="text-sm text-[#A5D6A7] mb-8 leading-relaxed">
          It looks like you've lost your internet connection. But don't worry, all your downloaded lectures are safe and ready for offline viewing!
        </p>
        ...
        <div className="flex flex-col gap-3 w-full">
          <Link
            ...
            className="flex items-center justify-center gap-3 px-6 py-4 bg-spring-leaf text-[#0F1908] hover:bg-spring-mint transition-all duration-300 shadow-lg hover:shadow-spring-mint/20 font-bold rounded-2xl hover:-translate-y-0.5 active:translate-y-0 text-md cursor-pointer"
            style={{
              background: "linear-gradient(135deg, #A5D6A7 0%, #81C784 100%)",
            }}
          >
            <HardDriveDownload className="w-5 h-5 text-[#0F1908]" />
            Go to My Downloads
          </Link>
